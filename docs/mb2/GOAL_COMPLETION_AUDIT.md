...
Status: audited against integrated head `d3b36037f` and
...
2. the reusable algebra and actor substrates remain bounded: application code
   ...
   resources/streams, and generated host/client composition are incomplete;
...
- move flagship runtime operands onto the public support-derived
  ...
  generated code;
- generate the remaining canonical Worker-host and actor-client composition
  from compiler intent, leaving only explicit GPU/capability handlers in app
  code;
...
shared-DAG/general sparse execution and fully generated actor host/client
composition remain incomplete; and durable full-workspace/hardware-WebGPU
