...
fn fs_main(@builtin(position) pos: vec4<f32>) -> @location(0) vec4<f32> {
    ...
    if _e4878 {
        ...
        edge_2118_18_phi_164_ = (((select(0u, select(select(bitcast<u32>(i32(_e5314)), 2147483648u, (_e5314 <= -2147483600f)), 2147483647u, (_e5314 >= 2147483600f)), (_e5314 == _e5314)) + (select(0u, select(select(bitcast<u32>(i32(_e5382)), 2147483648u, (_e5382 <= -2147483600f)), 2147483647u, (_e5382 >= 2147483600f)), (_e5382 == _e5382)) << 8u)) + (select(0u, select(select(bitcast<u32>(i32(_e5450)), 2147483648u, (_e5450 <= -2147483600f)), 2147483647u, (_e5450 >= 2147483600f)), (_e5450 == _e5450)) << 16u)) + 4278190080u);
        let _e5478 = edge_2118_18_phi_164_;
        phi_164_ = _e5478;
    }
    let _e5481 = phi_164_;
