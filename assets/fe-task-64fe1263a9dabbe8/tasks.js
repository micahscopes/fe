...
export function createMaterializedTaskRegistry(wasmExports) {
  ...
  registry["watch_pointer"] = createMaterializedTaskMachine({
    ...
    continuations: [
      ...
      { state: 2, range: { start: 28, count: 13 }, pending: { start: 28, count: 1 }, frame: { start: 29, count: 12 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task1Resume1(...lanes) },
      { state: 3, range: { start: 41, count: 13 }, pending: { start: 41, count: 1 }, frame: { start: 42, count: 12 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task1Resume2(...lanes) },
    ],
  });
  ...
  registry["watch_viewport"] = createMaterializedTaskMachine({
    ...
    continuations: [
      { state: 1, range: { start: 2, count: 14 }, pending: { start: 2, count: 1 }, frame: { start: 3, count: 13 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }, { kind: "f32", bits: 32 }, { kind: "f32", bits: 32 }, { kind: "f32", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 3 } }, invoke: (...lanes) => task2Resume0(...lanes) },
      { state: 2, range: { start: 16, count: 7 }, pending: { start: 16, count: 1 }, frame: { start: 17, count: 6 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task2Resume1(...lanes) },
      { state: 3, range: { start: 23, count: 7 }, pending: { start: 23, count: 1 }, frame: { start: 24, count: 6 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task2Resume2(...lanes) },
    ],
  });
  ...
  registry["watch_visibility"] = createMaterializedTaskMachine({
    input: [],
    step: [{ kind: "enum_tag", bits: 8, variants: 4 }, { kind: "unsigned", bits: 32 }, { kind: "unsigned", bits: 32 }, { kind: "unsigned", bits: 32 }, { kind: "bool", bits: 1 }, { kind: "enum_tag", bits: 8, variants: 5 }, { kind: "enum_tag", bits: 8, variants: 2 }, { kind: "unsigned", bits: 32 }, { kind: "bool", bits: 1 }, { kind: "unsigned", bits: 32 }, { kind: "bool", bits: 1 }, { kind: "enum_tag", bits: 8, variants: 2 }, { kind: "unsigned", bits: 32 }, { kind: "unsigned", bits: 32 }, { kind: "bool", bits: 1 }, { kind: "enum_tag", bits: 8, variants: 2 }, { kind: "unsigned", bits: 32 }, { kind: "unsigned", bits: 32 }, { kind: "unsigned", bits: 32 }, { kind: "bool", bits: 1 }, { kind: "enum_tag", bits: 8, variants: 2 }, { kind: "unsigned", bits: 32 }],
    complete: { start: 1, count: 1 },
    start: (...lanes) => task3Start(...lanes),
    continuations: [
      { state: 1, range: { start: 2, count: 10 }, pending: { start: 2, count: 1 }, frame: { start: 3, count: 9 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }, { kind: "enum_tag", bits: 8, variants: 2 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 1 } }, invoke: (...lanes) => task3Resume0(...lanes) },
      { state: 2, range: { start: 12, count: 5 }, pending: { start: 12, count: 1 }, frame: { start: 13, count: 4 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task3Resume1(...lanes) },
      { state: 3, range: { start: 17, count: 5 }, pending: { start: 17, count: 1 }, frame: { start: 18, count: 4 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task3Resume2(...lanes) },
    ],
  });
  ...
  registry["watch_wheel"] = createMaterializedTaskMachine({
    ...
    continuations: [
      ...
      { state: 2, range: { start: 26, count: 12 }, pending: { start: 26, count: 1 }, frame: { start: 27, count: 11 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task4Resume1(...lanes) },
      { state: 3, range: { start: 38, count: 12 }, pending: { start: 38, count: 1 }, frame: { start: 39, count: 11 }, delivery: { lanes: [{ kind: "enum_tag", bits: 8, variants: 3 }, { kind: "unsigned", bits: 32 }], failure: { start: 1, count: 1 }, success: { start: 2, count: 0 } }, invoke: (...lanes) => task4Resume2(...lanes) },
    ],
  });
