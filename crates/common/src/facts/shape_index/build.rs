...
use crate::{
    facts::{
        FactId, FactIndexError, FactNamespace, ShapeFactIndex, ShapeHashFact, ShapeHashFactKey,
        ShapeHashScope, TypedFactSet,
        index_error::{require_fact_namespace, require_non_empty_shape_fact_text},
    },
