...
use super::{
    ...
    generated::{GeneratedImplId, GeneratedRequirement},
...
impl<'db> TyChecker<'db> {
    ...
    fn generated_requirement_diag_info(
        ...
        let message = self.generated_requirement_diag_message(generated, requirement);
            ...
            .find_map(|generated| {
                generated
                    ...
                    .find_map(|requirement| {
                        let ConstraintKind::Trait(required) = requirement.constraint.kind(self.db)
                        else {
                            return None;
                        };
                        (required == unsat_subgoal).then(|| {
                            let message =
                                self.generated_requirement_diag_message(*generated, requirement);
                            let span = requirement
                                .origin
                                .diagnostic_span(self.db)
    ...
    fn generated_requirement_diag_message(
        &self,
        generated: GeneratedImplId<'db>,
        requirement: &GeneratedRequirement<'db>,
    ) -> String {
        ...
        let request = generated.context.request(self.db).pretty_print(self.db);
        format!(
            "required by generated obligation {} {} (generated by {provider} for `{request}`)",
