...
"#,
    ...
    assert_eq!(
        ...
        vec!["generated stub Foo: Eq with obligations {}".to_string()]
    );
}
...
"#,
    ...
    assert_eq!(
        generated_impl_summaries_for_top_mod(&db, top_mod),
        vec!["generated stub Box: Eq with obligations {FieldTy: Eq}".to_string()]
    );
}
...
"#,
    ...
    assert_eq!(
        ...
        vec![
            "Box: Eq requested by derive attribute".to_string(),
            "Box: Eq generated by derive_eq".to_string(),
            "Box: Eq generated output source stub".to_string(),
...
"#,
    ...
    assert_eq!(
        generated_trace_summaries_for_top_mod(&db, top_mod),
        vec![
            "Pair: Eq requested by derive attribute".to_string(),
            "Pair: Eq generated by derive_eq".to_string(),
            "Pair: Eq generated output source stub".to_string(),
...
"#,
    ...
    assert_eq!(
        generated_impl_summaries_for_top_mod(&db, top_mod),
        vec!["generated stub Pair<A, B>: Eq with obligations {A: Eq, B: Eq}".to_string()]
    );
}
...
"#,
    ...
    assert_eq!(
        generated_impl_summaries_for_top_mod(&db, top_mod),
        vec!["generated stub Box: Default with obligations {FieldTy: Default}".to_string()]
    );
}
...
"#,
    ...
    let (top_mod, _) = db.top_mod(file);
    let diags = diagnostics_for(&db, top_mod);
    assert_diag_message(&diags, "generated stub impls cannot satisfy `Eq`");
}
