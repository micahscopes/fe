...
fn builtin_source_str(source: SpirvBuiltinSource) -> &'static str {
    match source {
        ...
        SpirvBuiltinSource::GlobalInvocationIdZ => "GlobalInvocationIdZ",
        SpirvBuiltinSource::LocalInvocationIdX => "LocalInvocationIdX",
        SpirvBuiltinSource::LocalInvocationIdY => "LocalInvocationIdY",
        SpirvBuiltinSource::LocalInvocationIdZ => "LocalInvocationIdZ",
        SpirvBuiltinSource::WorkgroupIdX => "WorkgroupIdX",
        SpirvBuiltinSource::WorkgroupIdY => "WorkgroupIdY",
        SpirvBuiltinSource::WorkgroupIdZ => "WorkgroupIdZ",
        SpirvBuiltinSource::NumWorkgroupsX => "NumWorkgroupsX",
        SpirvBuiltinSource::NumWorkgroupsY => "NumWorkgroupsY",
        SpirvBuiltinSource::NumWorkgroupsZ => "NumWorkgroupsZ",
        SpirvBuiltinSource::LocalInvocationIndex => "LocalInvocationIndex",
