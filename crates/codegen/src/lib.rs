...
pub use sonatina::{
    HOST_COMPLETION_RUNTIME_JS, LowerError, MATERIALIZED_TASK_RUNTIME_JS, PreparedWasmEmission,
    SonatinaContractBytecode, SonatinaTestOptions, WasmCompileOptions, WasmTaskAdapter,
    WasmTaskContinuation, WasmTaskDelivery, WasmTaskRange, WasmTaskScalar,
    compile_prepared_runtime_package_wasm, compile_runtime_package_wasm_with_options,
    ...
    emit_test_module_sonatina, materialized_task_adapters,
    prepare_runtime_package_wasm_with_options, validate_module_sonatina_ir,
};
#[cfg(feature = "spirv-backend")]
pub use sonatina::{
...
pub use web_bundle::{
    ...
    WebCanonicalStatus, WebControl, WebControlArgSource, WebControlWasmType, WebDepthCompare,
    WebDepthFormat, WebDepthPolicy, WebDispatchCooperation, WebDispatchTaper, WebFaceCull,
    WebFeResponsibility, WebFixedHostProvenance, WebGeneratedArtifact, WebGeneratedArtifactKind,
    WebHostResponsibility, WebLayout, WebPass, WebPassCycle, WebPassShader, WebProvenance,
    WebRasterPolicy, WebResource, WebResourceAccess, WebResourceArtifact, WebResourceAsset,
