#!/usr/bin/env python3
"""Inline the interactive Fe Clifford rotor page into a single self-contained
...
ctl.wasm as base64 bytes in window.CLIFFORD_LIVE_ASSETS), and all page JS folded into
...
def main():
    ...
    html = html.replace(
        "<title>Interactive Fe Clifford rotor: Fe render + Fe controls</title>",
        "<title>Interactive Fe Clifford rotor - standalone (inlined)</title>",
    )
